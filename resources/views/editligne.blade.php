...
<html lang="en">
  ...
  <path d="M8.354 1.146a.5.5 0 0 0-.708 0l-6 6A.5.5 0 0 0 1.5 7.5v7a.5.5 0 0 0 .5.5h4.5a.5.5 0 0 0 .5-.5v-4h2v4a.5.5 0 0 0 .5.5H14a.5.5 0 0 0 .5-.5v-7a.5.5 0 0 0-.146-.354L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293L8.354 1.146zM2.5 14V7.707l5.5-5.5 5.5 5.5V14H10v-4a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5v4H2.5z"/>
    ...
    <br>
    <br>
    <h1 class="text-center text-dark">Editer module #{{$lignemodule->id}}</h1>
    ...
    <div class="container">
        ...
        <form action="/updatel" method="POST">
            @csrf
            <input type="hidden" name="id" value="{{$lignemodule->id}}">
...
<div class="mb-3">
  ...
  <input type="date" class="form-control" name="dated" rows="3" value="{{$lignemodule['dated']}}" placeholder="saisir">
</div>
<div class="mb-3">
  <label for="datef" class="form-label">Date fin</label>
  <input type="date" class="form-control" name="datef" value="{{$lignemodule['datef']}}" rows="3" placeholder="saisir">
</div>
<div class="mb-3">
  <label for="volumeH" class="form-label">Volume</label>
  <input type="text" class="form-control" name="volumeH" value="{{$lignemodule['volumeH']}}" rows="3" placeholder="saisir">
</div>

            <center><button class="btn btn-primary mt-3">Editer</button></center>
</div>
          </form>
    </div>
