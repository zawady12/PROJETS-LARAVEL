...
<html lang="en">
  ...
  <path d="M8.354 1.146a.5.5 0 0 0-.708 0l-6 6A.5.5 0 0 0 1.5 7.5v7a.5.5 0 0 0 .5.5h4.5a.5.5 0 0 0 .5-.5v-4h2v4a.5.5 0 0 0 .5.5H14a.5.5 0 0 0 .5-.5v-7a.5.5 0 0 0-.146-.354L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293L8.354 1.146zM2.5 14V7.707l5.5-5.5 5.5 5.5V14H10v-4a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5v4H2.5z"/>
    ...
    <br>
    <br>
    <h1 class="text-center text-dark">PROFESSEURS</h1>
        @if(session('success'))
            <div class="alert alert-danger">
                {{ session('success') }}
            </div>
        @endif
        <form action="{{route('postprof')}}" method="POST">
            @csrf
...
<div class="mb-3">
  ...
  <input type="text" class="form-control" name="nomP" rows="3" placeholder="nom">
</div>
<div class="mb-3">
  <label for="prenomp" class="form-label">Prenom</label>
  <input type="text" class="form-control" name="prenomP" rows="3" placeholder="prenom">
</div>
<div class="mb-3">
  <label for="grade" class="form-label">Grade</label>
  <input type="text" class="form-control" name="grade" rows="3" placeholder="grade">
</div>
